...
graph_style = {
    "flex": "60%",  # Adjust the width of the graph
}
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            html.H3("Statistics"),
                            html.Ul([
                                html.Li([html.Strong("Name: "), html.Span(str(name), style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Error "), html.Span(str(error), style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Win Rate "), html.Span(str(win_rate), style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Average days off-side: "), html.Span((str(average_count)), style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Average days to revert: "), html.Span(str(average_revert), style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Average PnL "), html.Span(str(average_PnL) + " bps", style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Max PnL: "), html.Span((str(max_value_column1))+ " bps", style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Worst PnL "), html.Span(str(min_value_column1)+ " bps", style={"color": "green", "font-family": "Consolas"})]),
                                html.Li([html.Strong("Worst Mtm: "), html.Span(str(worst_mkm)+ " bps", style={"color": "green", "font-family": "Consolas"})]),
                            ])
                        ]
                    )
                ]
...
def gensmth(table):
    ...
    columns_to_drop = ['Unnamed: 0', 'name', 'error', 'Reversion']
    table = table.drop(columns=columns_to_drop)

    # Update values in column 'A' to contain only the first five characters
    table['PnL'] = table['PnL'].astype(str).str[:5]
    table['Mtm1'] = table['Mtm1'].astype(str).str[:5]
    table['Mtm2'] = table['Mtm2'].astype(str).str[:5]
