...
columns = ['Event Type','Time Stamp', 'Effective Date', 'Expiration Date', 'Rate', 'DV01']
            ...
            with z.open(file_list[0]) as f:
                ...
                for idx, row in new_df.iterrows():
                    ...
                    if (row["Notional currency-Leg 1"] in ["GBP", "USD", "EUR"]) and is_nan:
                        ...
                        if event_type:
                            new_row = {'Event Type':event_type,'Time Stamp':timestamp, 'Effective Date':eff_date, 'Expiration Date':exp_date,'Rate':rate, 'DV01':dv01}
